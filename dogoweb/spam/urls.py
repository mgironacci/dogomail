...
urlpatterns = [
    ...
    url(r'^rulessearch/$', views.rules_search, name='spamrulesearch'),
    url(r'^rules/create/$', views.rules_create, name='spam_rule_create'),
    url(r'^rules/update/(?P<pks>[\,\d]+)*$', views.rules_update, name='spam_rule_update'),
    url(r'^rules/delete/(?P<pks>[\,\d]+)*$', views.rules_delete, name='spam_rule_delete'),
    url(r'^rules/up/(?P<ids>[\,\d]+)*$', views.rules_up, name='spam_rule_up'),
    url(r'^rules/down/(?P<ids>[\,\d]+)*$', views.rules_down, name='spam_rule_down'),
