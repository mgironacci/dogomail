...
$(function(){
    ...
    var clickDTs = function (et, e, dt, indexes) {
        var dts =  $('#clientes-table').DataTable();
    ...
    // Servidores
    $('#clientes-table')
    .on('select.dt', function ( e, dt, type, indexes ) { clickDTs('select.cliente', e, dt, indexes); } )
    .on('deselect.dt', function ( e, dt, type, indexes ) { clickDTs('deselect.cliente', e, dt, indexes); } )
    .DataTable({
        responsive: true,
        serverSide: true,
        ajax: {
